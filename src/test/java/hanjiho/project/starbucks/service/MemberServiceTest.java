...
public class MemberServiceTest {
	...
	public void testC() {
		...
		try {
			count = memberService.getMemberCount(null);
	...
	public void testD() {
		...
		try {
			count = memberService.getMemberCount(input);
			log.debug("김회원이란 이름을 갖는 회원 데이터 수: " + count);
		} catch (Exception e) {
			log.error(e.getLocalizedMessage());
			e.printStackTrace();
		}
...
//	public void testE() {
//		Member input = new Member();
//		input.setUser_id("asd123");
//		input.setUser_pw("qweasd");
//		input.setUser_name("김회원");
//		input.setUser_email("aaa123@ddd.oo");
//		input.setPhone("031)255-8999");
//		input.setBirthday("1998-04-13");
//		input.setGender("F");
//		input.setIs_out("N");
//
//		int output = 0;
//
//		try {
//			output = memberService.addMember(input);
...
//
//		try {
//			output = memberService.editMember(input);
...
//
//		try {
//			output = memberService.deleteMember(input);
